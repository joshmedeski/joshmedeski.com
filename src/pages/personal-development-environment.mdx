...
- [Setting up Alacritty for a fast, minimal terminal emulator](/posts/setting-up-alacritty-for-a-fast-minimal-terminal-emulator)
- [Getting started with fish, the friendly interactive shell](/posts/getting-started-with-fish-the-friendly-interactive-shell)
