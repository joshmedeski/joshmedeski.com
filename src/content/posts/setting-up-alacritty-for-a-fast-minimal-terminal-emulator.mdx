...
This is just the starting point for customizing Alacrity. If you want to explore all of the customization options, I recommend looking through [Alacritty's sample configuration](https://github.com/alacritty/alacritty/blob/master/alacritty.yml). You can view my full Alacritty configuration [here](https://github.com/joshmedeski/dotfiles/blob/main/.config/alacritty/alacritty.yml).
