...
This is just the starting point for customizing Alacrity. If you want to explore all of the features Alacritty has to offer, check out the [GitHub repository](https://github.com/alacritty/alacritty) for more info. You can also view my full Alacritty configuration [here](https://github.com/joshmedeski/dotfiles/blob/main/.config/alacritty/alacritty.yml).
