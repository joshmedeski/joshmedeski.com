...
heroImage: >-
  ../attachments/posts/manage-macos-packages-with-homebrew/manage-macos-packages-with-homebrew.jpeg
thumbnail: >-
  ../attachments/posts/manage-macos-packages-with-homebrew/manage-macos-packages-with-homebrew-thumb.jpeg
description: >-
  Homebrew is a package manager for macOS that allows users to easily install
  and manage packages and libraries.
category: dotfiles
guide:
