---
title: Navigate the Web with Vim Keybindings
pubDate: 2016-03-06T23:59:00.169Z
description: >-
  I've been using a tool for probably over a year now that helps let's me
  navigate the web with Vim. It's a chrome extension
heroImage: ../attachments/posts/navigate-the-web-with-vim/navigate-the-web-with-vim.jpeg
...
<img src="/attachments/posts/navigate-the-web-with-vim/vimium-help-screen.jpg" alt="Vimium help screen" width="828" height="605" />Here are some of the commands I use the most everyday:
...
<img src="/attachments/posts/navigate-the-web-with-vim/vimium-f-command.jpg" alt="Vimium f command" width="815" height="611" />I used to use a similar plugin in my old code editor called <a href="https://atom.io/packages/jumpy" target="_blank" rel="noopener">Jumpy</a>. For me, it's a really easy way to keep from having to use the mouse so much on the web.
