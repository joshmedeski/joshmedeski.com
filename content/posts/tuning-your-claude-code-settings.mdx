...
> [!NOTE] Last edited: July 20, 2026
> This is a living post. I tweak my Claude Code setup constantly, so I'll keep this updated and bump the date whenever I do.
...
Mine are heavier than most starter configs. Three do the real work: a desktop notifier on `Notification` events, a leaderkey config reorder after any `Write`/`Edit`, and the [RTK](https://github.com/joshmedeski) token-saving proxy rewrite on every Bash call.
