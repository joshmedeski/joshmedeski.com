...
import popupPreview from '../attachments/posts/popup-history-with-tmux-and-fzf/popup-history-with-tmux-and-fzf.jpeg'
...
/>
Thanks for reading, I will continue to post tips and tricks for how to be more
productive in the terminal and macOS.
