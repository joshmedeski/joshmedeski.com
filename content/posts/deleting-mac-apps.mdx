...
import appCleaner from '../attachments/posts/deleting-mac-apps/app-cleaner-candybar-screenshot.png'
...
/>
Next, AppCleaner will display all the necessary files to delete to remove the
app. Click the "delete" button and your all done!
