...
import helpScreen from '../attachments/posts/navigate-the-web-with-vim/vimium-help-screen.jpg'
import fCommand from '../attachments/posts/navigate-the-web-with-vim/vimium-f-command.jpg'
...
<Image src={helpScreen} alt="Vimium help screen" />
...
<Image src={fCommand} alt="Vimium f command" />I used to use a similar plugin in
my old code editor called
<a href="https://atom.io/packages/jumpy" target="_blank" rel="noopener">
  Jumpy
</a>
. For me, it's a really easy way to keep from having to use the mouse so much on
the web.
